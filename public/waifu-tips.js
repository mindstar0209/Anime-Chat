...
! function () {
    ...
    const n = {
        ...
        quit: {
            ...
            callback: () => {
                localStorage.setItem("waifu-display", Date.now()), o("愿你有一天能与重要的人重逢。", 2e3, 11), document.getElementById("waifu"), setTimeout((() => {
    ...
    function i(t) {
        ...
        function c(t) {
            ...
            window.addEventListener("mousemove", (() => i = !0)), window.addEventListener("keydown", (() => i = !0)), setInterval((() => {
                i ? (i = !1, clearInterval(s), s = null) : s || (s = setInterval((() => {
                    o(c, 6e3, 9)
                }), 2e4))
            }), 1e3), o(function (e) {
                ...
                for (let {
                    ...
                    of t.click)
                    if (s.target.closest(n)) return i = e(i), i = i.replace("{text}", s.target.innerText), void o(i, 4e3, 8)
            })), t.seasons.forEach((({
                date: t,
                text: o
            }) => {
                const s = new Date,
                    n = t.split("-")[0],
                    i = t.split("-")[1] || n;
                n.split("/")[0] <= s.getMonth() + 1 && s.getMonth() + 1 <= i.split("/")[0] && n.split("/")[1] <= s.getDate() && s.getDate() <= i.split("/")[1] && (o = (o = e(o)).replace("{year}", s.getFullYear()), c.push(o))
            }));
            const a = () => { };
            console.log("%c", a), a.toString = () => {
        ...
        localStorage.removeItem("waifu-display"), sessionStorage.removeItem("waifu-text"), document.body.insertAdjacentHTML("beforeend", ''), setTimeout((() => {
            ...
            function () {
                ...
                null === e && (e = 4, o = 53), i.loadModel(e, o), fetch(t.waifuPath).then((e => e.json())).then(c)
            }()
    }
